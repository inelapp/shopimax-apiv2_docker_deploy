...
import userRoutes from './services/auth/auth.service';
...
app.use('/api/v1', orderRoutes, productRoutes, agentService, providerRoutes, storageService, purchaseRoutes, userRoutes);
